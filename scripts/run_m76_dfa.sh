...
#SBATCH --job-name run_m76_dfa ### name of the job. replace my_job with your desired job name
#SBATCH --output run_m76_dfa.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/main.py  -B m76 -M rpni -D FE -T 1
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/main.py  -B m76 -M rpni -D FE -T 2
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/main.py  -B m76 -M rpni -D FE -T 3
