...
#SBATCH --job-name run_check_traces ### name of the job. replace my_job with your desired job name
#SBATCH --output run_check_traces.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/check_traces.py