...
#SBATCH --job-name run_m76_dfa1 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_m76_dfa1.out ### output log for running job - %J is the job number variable
