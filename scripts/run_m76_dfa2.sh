...
#SBATCH --job-name run_m76_dfa2 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_m76_dfa2.out ### output log for running job - %J is the job number variable
...
#SBATCH --mem=300G ### total amount of RAM // 500
#SBATCH --ntasks=1
