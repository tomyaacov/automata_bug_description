...
#SBATCH --job-name run_m24_T ### name of the job. replace my_job with your desired job name
#SBATCH --output run_m24_T.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/rers_sul.py  -B m24 -D T -W 300 -L 40