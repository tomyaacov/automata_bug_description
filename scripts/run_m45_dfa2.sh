...
#SBATCH --job-name run_m45_dfa2 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_m45_dfa2.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/main.py  -B m45 -M rpni -D FE -T 2