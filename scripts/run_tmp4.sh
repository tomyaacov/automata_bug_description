...
#SBATCH --job-name run_tmp4 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_tmp4.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/tmp4.py