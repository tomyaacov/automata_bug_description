...
#SBATCH --job-name test_create_t_from_lstar ### name of the job. replace my_job with your desired job name
#SBATCH --output test_create_t_from_lstar.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/create_t_from_lstar.py