...
#SBATCH --job-name run_m135_B ### name of the job. replace my_job with your desired job name
#SBATCH --output run_m135_B.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/lstar/bin/python ~/repos/l_star_based_bug_description/rers_sul.py  -B m135 -D B -W 200 -L 30