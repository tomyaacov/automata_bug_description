import argparse
from main_b_single import main_single
import pandas as pd
from stopit import SignalTimeout as Timeout
import random

parser = argparse.ArgumentParser()
parser.add_argument('--benchmark', '-B', type=str, default="m95")
...
df.to_csv(f'output/results_b_{args.benchmark}_T{args.t_type}_{args.method}.csv', index=False)
